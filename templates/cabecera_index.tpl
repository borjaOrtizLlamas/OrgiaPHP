...
<header>
     <div class="container">
          ...
          <div id="sign"> {if $logeado eq 1}<a href="verUser.php"><i class="fa fa-cog"></i>Cuenta</a><a href="funciones/log_des.php"><i class="fa fa-power-off"></i>Salir</a>{else}<a href="register.php"><i class="fa fa-user"></i>Login/Registro</a>{/if}</div>
     </div>
</header>
