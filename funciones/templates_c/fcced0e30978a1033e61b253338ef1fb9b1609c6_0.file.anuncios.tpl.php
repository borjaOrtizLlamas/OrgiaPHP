<?php /* Smarty version 3.1.27, created on 2016-02-26 09:14:27
         compiled from "C:\AD_PHP\Apache2.2\htdocs\trabajofinal\funciones\templates\anuncios.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:1337856d0096318d908_43069164%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fcced0e30978a1033e61b253338ef1fb9b1609c6' => 
    array (
      0 => 'C:\\AD_PHP\\Apache2.2\\htdocs\\trabajofinal\\funciones\\templates\\anuncios.tpl',
      1 => 1456390104,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1337856d0096318d908_43069164',
  'variables' => 
  array (
    'datos' => 0,
    'dato' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56d009632daf05_09800869',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56d009632daf05_09800869')) {
function content_56d009632daf05_09800869 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '1337856d0096318d908_43069164';
?>
<?php echo '<script'; ?>
...
" name="id_anuncio"/>
					<input type="submit" 'formaction="editarAnuncio.php"' value="Editar anuncio"/>
					<input type="submit" formaction="funciones/borrarAnuncio.PHP" value="Eliminar"/>
					<?php if ($_smarty_tpl->tpl_vars['dato']->value['tipo_de_usuario'] == "admin") {?>
						<input type="submit" 'formaction="ban.php"' value="ban"/>
					<?php }?>
				</form>
				</div>
            <?php }?>
            ...
            <div class="row">
                <div class="col-lg-12  col-sm-12 col-md-12 col-xs-12">
                    <div class="element">contacto</div>
                </div>    
            </div>     
        </div>
