"use strict";
	...
	function getMessage(id1, comprobacion, asinc){
    	...
    	xmlhttp.open("GET","funciones/validaciones/"+comprobacion+".php?val=" + document.getElementById(id1).value ,asinc);
    	xmlhttp.send();
		if (!asinc){
	...
	function getMessage2(id1, id2, comprobacion, asinc){
    	...
    	if(id1==="pass1"){
    		xmlhttp.open("GET","funciones/validaciones/" + comprobacion + ".php?val=" + document.getElementById(id1).value + "&val2=" + document.getElementById(id2).value ,asinc);
		}else{
			xmlhttp.open("GET","funciones/validaciones/" + comprobacion + ".php?val=" + id1 + "&val2=" + id2 ,asinc);
		}
    	xmlhttp.send();
		if (!asinc){
			document.getElementById(capa).innerHTML=xmlhttp.responseText;
	...
	function borrarUser(){
		document.getElementById("form").action = "funciones/borrarUser.php";
	...
	function comprobarUpdateUser(){
		...
		if (para){
			document.getElementById("form").action="funciones/updateUser.php";
			document.getElementById("form").submit();
		}
	}